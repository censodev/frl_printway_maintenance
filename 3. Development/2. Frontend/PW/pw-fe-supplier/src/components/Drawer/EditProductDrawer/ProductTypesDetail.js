...
class ProductTypesDetail extends Component {
                                                                            ...
                                                                            const dataSource = fields2.map((field2, index) => {
                                                                                ...
                                                                                return {
                                                                                    ...
                                                                                    baseSku: (
                                                                                        <span>
                                                                                        {
                                                                                            getFieldValue('productTypes')[field.name].variantDetails[field2.name].baseSku
                                                                                        }
                                                                                    </span>
                                                                                    ),
                                                                                    enable: (
                                                                ...
                                                                >
                                                                    <Form.List name={[field.name, 'printFileImages']}>
                                                                        {(fields2) => {
                                                                            ...
                                                                            const dataSource = fields2.map((field2) => {

                                                                                let idImage = null;
                                                                                let currentThumbUrl = getFieldValue('productTypes')[field.name].printFileImages[field2.name].image;
                                                                                if (currentThumbUrl && currentThumbUrl.id) {
                                                                                    if (currentThumbUrl.thumbUrl) {
                                                                                        idImage = currentThumbUrl.thumbUrl;
                                                                                    } else {
                                                                                ...
                                                                                return {
                                                                                    image: (
                                                                                        ...
                                                                                        >
                                                                                            <Upload
                                                                                                className="productTypePrintFile-uploader"
                                                                                                {...props}
                                                                                                disabled={(getFieldValue('productTypes')[field.name].printFileImages[field2.name].custom) || (disableUpload)}
                                                                                            >
                                                                                                {
                                                                                                    idImage ?
                                                                                                        <img
                                                                                    ...
                                                                                    name: (
                                                                                        <span>
                                                                                        {
                                                                                            getFieldValue('productTypes')[field.name].printFileImages[field2.name].name
                                                                                        }
                                                                                    </span>
                                                                                    ),
                                                                                    size: (
                                                                                        <span>
                                                                                        {
                                                                                            `${getFieldValue('productTypes')[field.name].printFileImages[field2.name].width || ''}/${getFieldValue('productTypes')[field.name].printFileImages[field2.name].height || ''}`
                                                                                        }
                                                                                    </span>
                                                                                    ),
                                                                                    note: (
                                                                                        <span>
                                                                                        {
                                                                                            getFieldValue('productTypes')[field.name].printFileImages[field2.name].note
                                                                                        }
                                                                                    </span>
                                                                                    ),
                                                                                    custom: (
                                                                                        <Form.Item
                                                                                            name={[field2.name, 'custom']}
                                                                                            valuePropName="checked"
                                                                                            style={{marginBottom: 0}}
                                                                                        >
                                                                                            <Switch
                                                                            ...
                                                                            const columns = [
                                                                                ...
                                                                                },
                                                                                {
                                                                                    title: (
                                                                                        ...
                                                                                        >
                                                                                            Personalization <InfoCircleOutlined/>
                                                                                        </Tooltip>
                                                                                    ),
                                                                                    dataIndex: 'custom',
                                                                                    key: 'custom',
