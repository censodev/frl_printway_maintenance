            ...
            return (
                <Form
                    ...
                    initialValues={{
                        ...
                        ORDER_NEW_EMAIL: _.get(data, 'ORDER_NEW_EMAIL', false),
                        // ORDER_NEW_PUSH: _.get(data, 'ORDER_NEW_PUSH', false),

                        ORDER_UPDATE_PENDING_DESIGN_EMAIL: _.get(data, 'ORDER_UPDATE_PENDING_DESIGN_EMAIL', false),
                        // ORDER_UPDATE_PENDING_DESIGN_PUSH: _.get(data, 'ORDER_UPDATE_PENDING_DESIGN_PUSH', false),

                        ORDER_UPDATE_PENDING_EMAIL: _.get(data, 'ORDER_UPDATE_PENDING_EMAIL', false),
                        // ORDER_UPDATE_PENDING_PUSH: _.get(data, 'ORDER_UPDATE_PENDING_PUSH', false),
                        ...
                        ORDER_UPDATE_SHIPPED_EMAIL: _.get(data, 'ORDER_UPDATE_SHIPPED_EMAIL', false),
                        // ORDER_UPDATE_SHIPPED_PUSH: _.get(data, 'ORDER_UPDATE_SHIPPED_PUSH', false),
                ...
                >
                    ...
                    <Row gutter={24}>
                        <Col md={16} xs={16}>
                            ...
                            <span>News, your level, promos, events, new features and the lastest product updates for you</span>
                        </Col>
                        <Col md={4} xs={4}>
                            <Form.Item
                    ...
                    <Row gutter={24} style={{marginBottom: 20}}>
                        <Col md={16} xs={16}>
                            <p className={cls.subTitle}>New order</p>
                            <span>When you receive a new order or create an order manual successfully</span>
                        </Col>
                        <Col md={4} xs={4}>
                            <Form.Item
                                name="ORDER_NEW_EMAIL"
                                valuePropName="checked"
                            >
                                <Checkbox/>
                            </Form.Item>
                    ...
                    <Row gutter={24} style={{marginBottom: 20}}>
                        <Col md={16} xs={16}>
                            <p className={cls.subTitle}>Pending design</p>
                            <span>When the order status changes to “pending design”, remind 2 days 1 time</span>
                        </Col>
                        <Col md={4} xs={4}>
                            <Form.Item
                                name="ORDER_UPDATE_PENDING_DESIGN_EMAIL"
                                valuePropName="checked"
                            >
                                <Checkbox/>
                            </Form.Item>
                        ...
                        {/*<Col md={4} xs={4}>*/}
                        {/*    <Form.Item*/}
                        {/*        name="ORDER_UPDATE_PENDING_DESIGN_PUSH"*/}
                        {/*        valuePropName="checked"*/}
                        {/*    >*/}
                        {/*        <Checkbox/>*/}
                        {/*    </Form.Item>*/}
                    ...
                    <Row gutter={24} style={{marginBottom: 20}}>
                        <Col md={16} xs={16}>
                            <p className={cls.subTitle}>Pending</p>
                            <span>When the order status changes to “pending”</span>
                        </Col>
                        <Col md={4} xs={4}>
                            <Form.Item
                                name="ORDER_UPDATE_PENDING_EMAIL"
                                valuePropName="checked"
                            >
                                <Checkbox/>
                            </Form.Item>
                        ...
                        {/*<Col md={4} xs={4}>*/}
                        {/*    <Form.Item*/}
                        {/*        name="ORDER_UPDATE_PENDING_PUSH"*/}
                        {/*        valuePropName="checked"*/}
                        {/*    >*/}
                        {/*        <Checkbox/>*/}
                        {/*    </Form.Item>*/}
                    ...
                    <Row gutter={24} style={{marginBottom: 20}}>
                        <Col md={16} xs={16}>
                            <p className={cls.subTitle}>Shipped</p>
                            <span>When the order status changes to “shipped”</span>
                        </Col>
                        <Col md={4} xs={4}>
                            <Form.Item
                                name="ORDER_UPDATE_SHIPPED_EMAIL"
                                valuePropName="checked"
                            >
                                <Checkbox/>
                            </Form.Item>
                        ...
                        {/*<Col md={4} xs={4}>*/}
                        {/*    <Form.Item*/}
                        {/*        name="ORDER_UPDATE_SHIPPED_PUSH"*/}
                        {/*        valuePropName="checked"*/}
                        {/*    >*/}
                        {/*        <Checkbox/>*/}
                        {/*    </Form.Item>*/}
