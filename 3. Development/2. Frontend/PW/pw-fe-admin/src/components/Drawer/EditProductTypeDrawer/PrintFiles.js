...
import {Button, Card, Col, Collapse, Divider, Form, Input, InputNumber, message, Popconfirm, Row, Upload} from "antd";
            ...
            <Card
                ...
                extra={
                    <Button onClick={() => this.addFileBtn && this.addFileBtn.click()} type='link'>
                        <PlusOutlined/> Add Print File
                    </Button>
                }
            >
                <Row className={cls.headerVariants}>
                    <Col md={3} style={{paddingLeft: '8px'}}>Print File</Col>
