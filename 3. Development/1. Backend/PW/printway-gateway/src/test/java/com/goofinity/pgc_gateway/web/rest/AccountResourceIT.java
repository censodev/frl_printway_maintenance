...
import com.goofinity.pgc_gateway.PgcGatewayApp;
import com.goofinity.pgc_gateway.config.Constants;
import com.goofinity.pgc_gateway.domain.User;
import com.goofinity.pgc_gateway.repository.AuthorityRepository;
import com.goofinity.pgc_gateway.repository.UserRepository;
import com.goofinity.pgc_gateway.security.AuthoritiesConstants;
import com.goofinity.pgc_gateway.service.UserService;
import com.goofinity.pgc_gateway.service.dto.PasswordChangeDTO;
import com.goofinity.pgc_gateway.service.dto.UserDTO;
import com.goofinity.pgc_gateway.web.rest.vm.KeyAndPasswordVM;
import com.goofinity.pgc_gateway.web.rest.vm.ManagedUserVM;
...
import static com.goofinity.pgc_gateway.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = PgcGatewayApp.class)
public class AccountResourceIT {
    ...
    public void testRegisterValid() throws Exception {
        ...
        assertThat(userRepository.findOneByEmail("test-register-valid").isPresent()).isFalse();
        ...
        assertThat(userRepository.findOneByEmail("test-register-valid").isPresent()).isTrue();
    }
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        Optional<User> testUser1 = userRepository.findOneByEmail("test-register-duplicate-email");
        ...
        Optional<User> testUser2 = userRepository.findOneByEmail("test-register-duplicate-email");
        assertThat(testUser2.isPresent()).isFalse();

        Optional<User> testUser3 = userRepository.findOneByEmail("test-register-duplicate-email-2");
        ...
        Optional<User> testUser4 = userRepository.findOneByEmail("test-register-duplicate-email-3");
    ...
    public void testActivateAccount() throws Exception {
        ...
        user = userRepository.findOneByEmail(user.getLogin()).orElse(null);
    ...
    public void testSaveAccount() throws Exception {
        ...
        User updatedUser = userRepository.findOneByEmail(user.getLogin()).orElse(null);
