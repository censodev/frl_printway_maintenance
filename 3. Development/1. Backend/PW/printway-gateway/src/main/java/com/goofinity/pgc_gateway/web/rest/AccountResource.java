...
import com.goofinity.pgc_gateway.web.rest.errors.EmailAlreadyUsedException;
import com.goofinity.pgc_gateway.web.rest.errors.InvalidPasswordException;
import com.goofinity.pgc_gateway.web.rest.errors.LoginAlreadyUsedException;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        userService.syncUserToService(user);
    ...
    public void activateAccount(@RequestParam(value = "key") String key) {
        ...
        if (!user.isPresent()) {
            throw new InvalidDataException("activation_key");
        }

        userService.syncUserToService(user.get());
    }
    ...
    @PutMapping("/account")
    public void saveAccount(@Valid @RequestBody UserUpdateDTO userUpdateDTO) {
        User existingUser = userRepository.findOneByEmailIgnoreCase(SecurityUtils.getCurrentUserLogin()
            .orElseThrow(SecurityException::new)).orElseThrow(() -> new ObjectNotFoundException("user"));

        if (!userUpdateDTO.getRoles().contains(RoleEnum.ROLE_SUPPLIER.name())) {
    ...
    public void requestPasswordReset(@RequestBody UserDTO userDTO) {
