...
public class MailService {
    ...
    @Async
    public void sendLockEmail(User user) {
        log.debug("Sending lock/unlock email to '{}'", user.getEmail());
        sendEmailFromTemplate(user, "mail/lockEmail", "email.lock.title");
    }

    @Async
    public void sendUpdateUserEmail(User user) {
        log.debug("Sending change password email to '{}'", user.getEmail());
        sendEmailFromTemplate(user, "mail/updateUserEmail", "email.update.title");
    }
}
